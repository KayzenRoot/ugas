...
class VersionAndImageQARegressionTests(unittest.TestCase):
    def test_version_surfaces_are_consistent(self):
        ...
        self.assertEqual("0.7.1", UGAS_VERSION); self.assertEqual(UGAS_VERSION, ugas.__version__); self.assertEqual(UGAS_VERSION, package["version"]); self.assertEqual(UGAS_VERSION, pyproject["project"]["version"])
