...
O A/B v2 e os jobs do corretivo estão em `docs/evidence/multiref-v2-qualification.json`, `directional-anchor-set-v2.json`, `walk-v2-temporal-qa.json` e `execution-evidence-v0.5.1.json`. Health, disponibilidade de GPU ou cache não substituem prova end-to-end de prompt/history/output.
