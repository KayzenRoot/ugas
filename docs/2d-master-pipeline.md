...
# 2D master pipeline v0.22.1

The active correction is v0.22.1 UI Asset Family semantic integrity; v0.22.0 remains frozen rejected history, with external review required and production BLOCKED.
