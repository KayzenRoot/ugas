...
# 2D master pipeline v0.22.2

The active correction is v0.22.2 UI Asset Family F-15/F-16/F-18/F-20/F-21 integrity; v0.22.0 and v0.22.1 remain frozen rejected history, with external review required and production BLOCKED.
