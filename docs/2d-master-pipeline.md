...
# 2D master pipeline v0.23.1

The active correction/foundation is v0.23.1 VFX Asset Family F-22-F-28 integrity over approved/merged UI v0.22.3. The VFX fixtures are deterministic TEST_ONLY contracts, with external review required and production BLOCKED.
