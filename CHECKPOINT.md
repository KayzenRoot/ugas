...
O estado machine-authoritative está em [docs/evidence/current-state.json](docs/evidence/current-state.json). O piloto v0.8.0 reutiliza o cutout-rig R4 v0.7.1, o core estrutural v0.7.3 e os hashes K1–K4 como inputs imutáveis para oito frames front-walk.
