"""Fail-closed state checks for the v0.14.0 HIT_REACTION_FRONT technical qualification."""
...
CURRENT_GATE = "CUTOUT_ANIMATION_RUNTIME_V1_HIT_REACTION_FRONT_TECHNICALLY_QUALIFIED"
NEXT_ACTION = "external_visual_review_hit_reaction_front"
...
def validate_state_consistency(
    ...
    if state.get("schema_version") != CURRENT_VERSION or state.get("version") != CURRENT_VERSION:
        failures.append("version_must_be_0.14.0")
    ...
    if state.get("allowed_next_actions") != [NEXT_ACTION]:
        failures.append("next_action_must_be_external_visual_review_hit_reaction_front")
    ...
    if external.get("hit_reaction_front") != "REQUIRED":
        failures.append("hit_reaction_front_external_visual_review_must_be_required")
    ...
    if review.get("merge_authorization") == "APPROVED_TO_MERGE":
        failures.append("v0140_must_not_claim_merge_authorization")
    ...
    nested_expected = {
        ...
        "hit_reaction_front_external_visual": "REQUIRED",
    ...
    for key in ("historical_v0131_state", "historical_v0130_state", "historical_v0124_state", "capability_matrix", "contract", "execution", "visual_manifest", "negative_controls"):
    ...
    required_literals = (
        "0.14.0", CURRENT_PHASE, "HIT_REACTION_FRONT", CURRENT_GATE, NEXT_ACTION,
        "run_front_v1=APPROVED_PILOT", "hit_reaction_front=REQUIRED",
        ...
        "0.13.1", "f3d68faa5524392e66aee2fc2a450b9da8fa734b",
    ...
    return {
        ...
        "checked": {
            ...
            "external_visual": external.get("hit_reaction_front"), "production_routing": state.get("production_routing"),
