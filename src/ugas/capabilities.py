...
def declared_evidence(repo_root: Path, provider: str = "provider-comfyui", capability: str = "2d") -> dict:
    return {"schema_version": "0.3.0", "provider": provider, "capability": capability, "state": "declared", "endpoint": None, "server_version": None, "devices": [], "required_nodes": [], "required_models": [], "workflow": {}, "model": {}, "smoke_test": {"status": "not-run"}, "failure_reason": None, "observed_at": _now()}
