"""Fail-closed UI semantic runtime correction for UGAS v0.22.3.
...
SCHEMA_VERSION = "0.22.3"
RUNTIME_REVISION = "ui-asset-family-runtime-v0223"
FAMILY_ID = "ugas-ui-asset-family-v0223"
STYLE_TOKEN_SET_ID = "TEST_ONLY_UI_STYLE_V0223"
...
LOCAL_STYLE_AUTHORITY = {
    ...
    "authoritative_path": "docs/evidence/ui-asset-family-runtime-v0223/ui-style-authority-v0223.json",
    "semantic_revision": "v0.22.3",
    "identity": "TEST_ONLY_UI_STYLE_ART_DNA_V0223",
    ...
    if component_class == "progress_bar":
        ...
        metadata.update({
            ...
            "normalized_fill": {
                ...
                "direction": "positive", "clipping": "track", "clamp": False,
                "out_of_range": "REJECT",
...
def validate_progress_bar_contract(component: Mapping[str, Any], value: float | None = None) -> dict[str, Any]:
    ...
    _require(normalized.get("clipping") == "track" and normalized.get("clamp") is False and normalized.get("out_of_range") == "REJECT" and normalized.get("mapping") == "FLOOR_LINEAR", "UI_PROGRESS_POLICY_INVALID", "out-of-range policy")
...
def generate_fixture_pack(output_dir: Path) -> dict[str, Any]:
    ...
    write_json(output_dir / "ui-family-manifest-v0223.json", manifest)
