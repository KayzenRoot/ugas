"""Fail-closed active-state contract for the v0.21.3 maps/minimap correction."""
...
REJECTED_V0212_HEAD = "b80f30074374c539e008ce160846848f1c171d9a"
...
def validate_state_consistency(state: Mapping[str, Any], checkpoint_text: str = "", review_text: str = "", roadmap_text: str = "") -> dict[str, Any]:
    ...
    for version, head in (("v0.21.0", REJECTED_V0210_HEAD), ("v0.21.1", REJECTED_V0211_HEAD), ("v0.21.2", REJECTED_V0212_HEAD)):
