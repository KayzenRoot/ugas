"""Fail-closed active-state contract for the v0.20.1 QA-integrity correction."""
...
CURRENT_GATE = "ENVIRONMENT_TILESETS_AUTOTILE_WORLD_METRIC_VARIANT_INTEGRITY_TECHNICALLY_QUALIFIED"
NEXT_ACTION = "external_review_environment_tilesets_v0201"
...
def validate_state_consistency(state: Mapping[str, Any], checkpoint_text: str = "", review_text: str = "", roadmap_text: str = "") -> dict[str, Any]:
    ...
    literals = ("0.20.1", "0.20.0", "0.19.1", CURRENT_PHASE, CURRENT_GATE, NEXT_ACTION, "items_props=APPROVED_FOUNDATION", "environment_tilesets_runtime_external_review=REQUIRED", "real_environment_asset_coverage=NONE", "synthetic_environment_fixture=TEST_ONLY", "production_approved=false", "production_routing=BLOCKED", "new_generation=0", "TEST_ONLY_TILE_QA_BOARD_V0201", "external_review_environment_tilesets_v0201", "v0200_external_review=CORRECTION_REQUIRED")
