...
from ..state_consistency_v0150 import validate_state_consistency

# The active state/review moved to v0.15.0. The v0.12.2 index remains the
# immutable baseline evidence used to bind the local observer.
ACTIVE_VERSION = "0.15.0"
ACTIVE_REVIEW = "REVIEW-v0.15.0.md"
