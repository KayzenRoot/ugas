...
from ..state_consistency_v0200 import validate_state_consistency
...
ACTIVE_VERSION = "0.20.0"
ACTIVE_REVIEW = "REVIEW-v0.20.0.md"
...
class ActiveEvidenceCache:
    ...
    def __init__(self, repo_root: Path, *, state_path: Path | None = None, state_schema_path: Path | None = None,
        ...
        self.state_schema_path = state_schema_path or self.repo_root / "schemas/current-state-v0200.json"
