"""Fail-closed, provider-neutral orchestration runtime for UGAS v0.24.6.

Forward-only correction of the v0.24.6 TEST_ONLY control plane.  This module
...
TEST_ONLY_ROUTE_EXECUTOR_IDENTITY = "test-only-fake-executor-v0246"
...
def assert_provider_boundary(source: str | Path | None = None) -> dict[str, Any]:
    if source is None:
        ...
        source_name = "ugas.orchestration_runtime_v0246.OrchestrationRuntime"
