"""Fail-closed active-state validator for UGAS orchestration v0.24.7."""
...
V0246_REJECTED_HEAD = REJECTED_REVIEWED_HEAD
V0245_REJECTED_HEAD = "2a5c1d6d88c1348c1490cb9c89f16e2cc6b64362"
...
def validate_state_consistency(state: Mapping[str, Any], checkpoint_text: str, roadmap_text: str, matrix: Mapping[str, Any], binding: Mapping[str, Any] | None = None, evidence: Mapping[str, Any] | None = None) -> dict[str, Any]:
    ...
    v0246 = _mapping(history.get("v0.24.6"))
