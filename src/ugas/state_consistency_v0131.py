"""Fail-closed state checks for the v0.13.1 RUN_FRONT_V1 flight/QA correction."""
...
def validate_state_consistency(
    ...
    if previous.get("version") != "0.13.0":
        failures.append("previous_release_must_be_0.13.0")
    ...
    for key in ("historical_v0130_state", "historical_v0124_state", "capability_matrix", "contract", "execution", "visual_manifest", "negative_controls"):
    ...
    required_literals = (
        ...
        "ALWAYS_ON_DASHBOARD_POLICY=ENABLED", "DOCKER_ALWAYS_ON_LOCAL", "PR #3",
    )
    combined = "\n".join(active_sources)
