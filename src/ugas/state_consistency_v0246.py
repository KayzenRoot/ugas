"""Fail-closed active-state validator for UGAS orchestration v0.24.6."""
...
V0245_REJECTED_HEAD = REJECTED_REVIEWED_HEAD
V0244_REJECTED_HEAD = "55d6ee80f29d4cf6ed9f2d65e0173dbba570a124"
V0244_SEMANTIC_HEAD = "0c5226fcaaf90e0ddc5131749976afb6d6dd3153"
V0243_REJECTED_HEAD = "5a619c0b98ced7e4c09afd9ca117a039f0d5d068"
V0242_REJECTED_HEAD = "cd3345db7c0e587915e56eb9314879c4a9cf98a3"
...
CURRENT_GATE = "ORCHESTRATION_RUNTIME_HARDENING_F43R_F44_F45_F46_CORRECTION_TECHNICALLY_QUALIFIED_EXTERNAL_REVIEW_REQUIRED"
STOP_REASON = "ORCHESTRATION_RUNTIME_HARDENING_F43R_F44_F45_F46_EXTERNAL_REVIEW_REQUIRED"
NEXT_ACTION = "external_review_orchestration_runtime_v0246"
...
def validate_state_consistency(state: Mapping[str, Any], checkpoint_text: str, roadmap_text: str, matrix: Mapping[str, Any], binding: Mapping[str, Any] | None = None, evidence: Mapping[str, Any] | None = None) -> dict[str, Any]:
    ...
    if v0242.get("status") != "CORRECTION_REQUIRED" or v0242.get("rejected_reviewed_head") != V0242_REJECTED_HEAD or v0242.get("historical_evidence_unchanged") is not True:
        failures.append("v0242_correction_history_invalid")
    v0243 = _mapping(history.get("v0.24.3"))
    if v0243.get("status") != "CORRECTION_REQUIRED" or v0243.get("rejected_reviewed_head") != V0243_REJECTED_HEAD or v0243.get("historical_evidence_unchanged") is not True:
        failures.append("v0243_correction_history_invalid")
    v0244 = _mapping(history.get("v0.24.4"))
    if v0244.get("status") != "CORRECTION_REQUIRED" or v0244.get("rejected_reviewed_head") != V0244_REJECTED_HEAD or v0244.get("historical_evidence_unchanged") is not True:
        failures.append("v0244_correction_history_invalid")
    v0245 = _mapping(history.get("v0.24.5"))
    if v0245.get("status") != "CORRECTION_REQUIRED" or v0245.get("rejected_reviewed_head") != V0245_REJECTED_HEAD or v0245.get("historical_evidence_unchanged") is not True:
        failures.append("v0245_correction_history_invalid")
    ...
    if binding_value:
        if binding_value.get("base_main_sha") != BASELINE_MAIN_SHA or binding_value.get("reviewed_head") != REJECTED_REVIEWED_HEAD or binding_value.get("status") != "CORRECTION_REQUIRED":
            failures.append("v0245_binding_invalid")
    evidence_value = evidence or {}
    if evidence_value and evidence_value.get("orchestration_root") != "docs/evidence/orchestration-runtime-v0246/":
        failures.append("evidence_root_invalid")
    active = "\n".join((checkpoint_text, roadmap_text))
    for literal in (VERSION, CURRENT_GATE, STOP_REASON, NEXT_ACTION, "baseline_main_sha", "production_routing=BLOCKED", "new_generation=0", "F-43R", "F-44", "F-45", "F-46", "F-41", "F-42", "F-38", "F-37R", "F-39", "F-40", "F-31R", "F-32RR", "F-33", "F-34", "F-35RR", "F-35RC", "F-36", "external review"):
...
__all__ = ["BASELINE_MAIN_SHA", "BRANCH", "CURRENT_GATE", "CURRENT_PHASE", "NEXT_ACTION", "NEXT_CANDIDATE", "REJECTED_REVIEWED_HEAD", "STOP_REASON", "V0241_REJECTED_HEAD", "V0242_REJECTED_HEAD", "V0243_REJECTED_HEAD", "V0244_REJECTED_HEAD", "V0244_SEMANTIC_HEAD", "V0245_REJECTED_HEAD", "VERSION", "validate_state_consistency"]
