"""Fail-closed active-state contract for the v0.21.2 maps/minimap correction."""
...
NEXT_ACTION = "external_review_maps_minimap_v0212"
...
REJECTED_V0211_HEAD = "cfde03cce2e31cc688f9d94a659b577042b8538a"
...
def validate_state_consistency(state: Mapping[str, Any], checkpoint_text: str = "", review_text: str = "", roadmap_text: str = "") -> dict[str, Any]:
    ...
    for version, head in (("v0.21.0", REJECTED_V0210_HEAD), ("v0.21.1", REJECTED_V0211_HEAD)):
    ...
    literals = ("0.21.2", "0.21.1", "0.21.0", "0.20.3", "MAPS_MINIMAP", CURRENT_GATE, NEXT_ACTION, "environment_tilesets=APPROVED_FOUNDATION", "maps_minimap_runtime=TECHNICALLY_QUALIFIED_FOUNDATION", "real_map_asset_coverage=NONE", "real_minimap_asset_coverage=NONE", "synthetic_map_fixture=TEST_ONLY", "production_approved=false", "production_routing=BLOCKED", "new_generation=0", REJECTED_V0211_HEAD)
...
__all__ = ["BASELINE_HEAD", "CURRENT_GATE", "CURRENT_PHASE", "CURRENT_VERSION", "FEATURE_BRANCH", "NEXT_ACTION", "REJECTED_V0210_HEAD", "REJECTED_V0211_HEAD", "validate_state_consistency"]
