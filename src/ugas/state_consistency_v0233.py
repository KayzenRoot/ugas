"""Fail-closed state and live PR rules for VFX correction v0.23.3."""
...
PR_NUMBER = 14
CURRENT_GATE = "VFX_ASSET_FAMILY_RUNTIME_CORRECTION_F26S_F29_F30_TECHNICALLY_QUALIFIED_EXTERNAL_REVIEW_REQUIRED"
NEXT_ACTION = "external_review_vfx_asset_family_v0233"
...
def validate_state_consistency(state: Mapping[str, Any], checkpoint_text: str = "", roadmap_text: str = "", matrix: Mapping[str, Any] | None = None) -> dict[str, Any]:
    ...
    _check(failures, evidence.get("vfx_root") == "docs/evidence/vfx-asset-family-runtime-v0233/", "evidence-root")
    _check(failures, "VFX_ASSET_FAMILY" in checkpoint_text and CURRENT_GATE in checkpoint_text and "v0.23.3" in checkpoint_text, "checkpoint-binding")
    _check(failures, "v0.23.3" in roadmap_text and NEXT_ACTION in roadmap_text, "roadmap-binding")
