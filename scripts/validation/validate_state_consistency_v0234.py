"""Validate the active v0.23.4 state and live-only PR boundary."""
...
from ugas.state_consistency_v0234 import validate_state_consistency


def main() -> int:
    state = json.loads((ROOT / "docs/evidence/current-state.json").read_text(encoding="utf-8"))
    schema = json.loads((ROOT / "schemas/current-state-v0234.json").read_text(encoding="utf-8"))
