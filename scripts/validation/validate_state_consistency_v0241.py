"""Validate the active v0.24.1 state and its forward-only correction binding."""
...
from ugas.state_consistency_v0241 import validate_state_consistency
...
def main() -> int:
    ...
    binding_path = ROOT / "docs/evidence/orchestration-runtime-v0241/correction-history-v0241.json"
