"""Validate and persist the active v0.15.0 DEATH_ANIMATION_FRONT state."""
...
from ugas.state_consistency_v0150 import CURRENT_GATE, validate_state_consistency


def main() -> int:
    state = json.loads((ROOT / "docs/evidence/current-state.json").read_text(encoding="utf-8"))
    schema = json.loads((ROOT / "schemas/current-state-v0150.json").read_text(encoding="utf-8"))
    ...
    evidence = {
        ...
        "validator": "src/ugas/state_consistency_v0150.py",
        **result,
    }
    destination = ROOT / "docs/evidence/animation-runtime-v0150/state-consistency-v0150.json"
