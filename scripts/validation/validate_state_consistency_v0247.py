"""Validate the active v0.24.7 state and its forward-only correction binding."""
...
def main() -> int:
    ...
    binding_path = ROOT / "docs/evidence/orchestration-runtime-v0247/correction-history-v0247.json"
