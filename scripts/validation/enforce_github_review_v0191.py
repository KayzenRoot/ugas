"""Enforce the v0.19.1 review result after bounded artifact upload."""
...
if __name__ == "__main__":
    ...
    if validation.get("status") != "V0191_GITHUB_REVIEW_MANIFEST_PASSED": failures.append("manifest-validation-not-pass")
