...
def _v0123_checks() -> None:
    ...
    required = ["REVIEW-v0.12.3.md", "CONTRIBUTING.md", ".github/pull_request_template.md", ".github/workflows/ugas-ci.yml", ".github/workflows/ugas-review.yml", "docs/github-review-protocol.md", "docs/release-policy.md", "docs/ugas-v1-capability-matrix.md", "docs/ugas-v1-capability-matrix.json", "schemas/current-state.json", "schemas/current-state-v0.12.3.json", "schemas/github-review-manifest-v1.json", "schemas/ugas-v1-capability-matrix-v1.json", "scripts/validation/build_github_review_manifest.py", "scripts/validation/validate_github_review_manifest.py", "scripts/validation/validate_governance_v0123.py", "scripts/validation/validate_v1_capability_matrix.py", "scripts/validation/record_v0123_results.py", "scripts/docker/install-dashboard-autostart.ps1", "scripts/docker/uninstall-dashboard-autostart.ps1", "scripts/docker/ensure-dashboard-online.ps1", "docs/evidence/current-state.json"]
    for relative in required:
    ...
    check("v0123:workflow-triggers", all(literal in ci for literal in ("pull_request:", "workflow_dispatch:", "push:", "branches: [main]", "cancel-in-progress: true")) and all(literal in review for literal in ("pull_request:", "workflow_dispatch:", "fetch-depth: 0", "upload-artifact@v4")), "PR-first workflows have stable triggers and cancellation")
