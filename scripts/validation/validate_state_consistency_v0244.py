"""Validate the active v0.24.4 state and its forward-only correction binding."""
...
from ugas.state_consistency_v0244 import validate_state_consistency
...
def main() -> int:
    ...
    binding_path = ROOT / "docs/evidence/orchestration-runtime-v0244/correction-history-v0244.json"
