"""Validate the bounded v0.24.1 review artifact security and path boundary."""
...
def main() -> int:
    ...
    failures: list[str] = []
    allowed_prefixes = (
        "docs/evidence/orchestration-runtime-v0241/",
        "docs/evidence/current-state.json",
        "schemas/current-state-v0241.json",
        "schemas/orchestration-runtime-v0241.json",
        "REVIEW-v0.24.1.md",
        "github-review-manifest-v0241.json",
