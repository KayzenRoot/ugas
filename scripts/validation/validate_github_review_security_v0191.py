"""Validate that the v0.19.1 bounded artifact contains no sensitive payloads."""
...
def main() -> int:
    ...
    value = {"schema_version": "0.19.1", "status": "PASS" if not failures else "FAIL", "failures": failures, "artifact_root": str(root), "secrets_included": False, "model_weights_included": False}
