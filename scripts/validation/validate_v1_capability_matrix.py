...
def main() -> int:
    ...
    if value["version"] != "0.20.2":
        failures.append("active-matrix-version-must-be-v0202")
    ...
    output = ROOT / "docs/evidence/environment-tilesets-runtime-v0202/capability-matrix-validation-v0202.json"
