...
def main() -> int:
    ...
    if value["version"] != "0.20.1":
        failures.append("active-matrix-version-must-be-v0201")
    ...
    output = ROOT / "docs/evidence/environment-tilesets-runtime-v0201/capability-matrix-validation-v0201.json"
