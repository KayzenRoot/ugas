...
def main() -> int:
    ...
    if value["version"] not in {"0.20.3", "0.21.0", "0.21.1"}:
        failures.append("active-matrix-version-must-be-v0203-v0210-or-v0211")
    ...
    if value["version"] in {"0.21.0", "0.21.1"} and (maps["status"] != "TECHNICALLY_QUALIFIED_FOUNDATION" or value["next_candidate"] != "MAPS_MINIMAP"):
    ...
    output = ROOT / "docs/evidence/maps-minimap-runtime-v0211/capability-matrix-validation-v0211.json" if value["version"] == "0.21.1" else ROOT / "docs/evidence/maps-minimap-runtime-v0210/capability-matrix-validation-v0210.json"
