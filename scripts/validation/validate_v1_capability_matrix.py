...
def main() -> int:
    ...
    if value["version"] not in {"0.20.3", "0.21.0"}:
        failures.append("active-matrix-version-must-be-v0203-or-v0210")
    ...
    if value["version"] == "0.21.0" and (maps["status"] != "TECHNICALLY_QUALIFIED_FOUNDATION" or value["next_candidate"] != "MAPS_MINIMAP"):
    ...
    output = ROOT / "docs/evidence/maps-minimap-runtime-v0210/capability-matrix-validation-v0210.json"
