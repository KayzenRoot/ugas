"""Enforce the final fail-closed v0.21.3 review result after upload."""
...
def main() -> int:
    ...
    if manifest.get("overall_status") != "PASS" or manifest.get("scope", {}).get("version") != "0.21.3": failures.append("manifest-not-pass-or-scope-invalid")
