"""Validate the bounded v0.24.3 exact-head review manifest fail-closed."""
...
def main() -> int:
    ...
    failures: list[str] = []
    if value.get("schema_version") != VERSION or value.get("manifest_type") != "github-ci-orchestration-runtime-v0243-review":
    ...
    expected_scope = {
        ...
        "allowed_next_actions": ["external_review_orchestration_runtime_v0243"],
