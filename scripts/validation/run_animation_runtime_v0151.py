...
def _death_negative_controls(spec: dict[str, Any], final_output: Path, run_a: Mapping[str, Any], run_b: Mapping[str, Any], hit_spec: dict[str, Any]) -> dict[str, Any]:
    ...
    return {"schema_version": "0.15.1", "status": "NC_01_TO_NC_16_PASSED" if passed else "NC_01_TO_NC_16_GAP", "controls": controls, "source": "scripts/validation/run_animation_runtime_v0151.py independent semantic, package and decoded-pixel mutations", "hit_spec_loop": hit_spec["loop"]}
