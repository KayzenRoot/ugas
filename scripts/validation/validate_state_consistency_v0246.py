"""Validate the active v0.24.6 state and its forward-only correction binding."""
...
from ugas.state_consistency_v0246 import validate_state_consistency
...
def main() -> int:
    ...
    binding_path = ROOT / "docs/evidence/orchestration-runtime-v0246/correction-history-v0246.json"
