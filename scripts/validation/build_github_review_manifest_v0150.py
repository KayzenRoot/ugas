"""Build the bounded v0.15.0 DEATH_ANIMATION_FRONT review manifest."""
...
BRANCH = "codex/v0.15.0-death-animation-front"
...
DEATH_EVIDENCE = "docs/evidence/animation-runtime-v0150"
...
def build(args: argparse.Namespace) -> dict[str, Any]:
    ...
    return {
        ...
        "repository": {
            "name": "csn1985-ship-it/ugas",
            "url": "https://github.com/csn1985-ship-it/ugas",
            "default_branch": "main",
        },
        "pull_request": {
            "number": pr_number,
        ...
        "review_index": {
            ...
            "active_manifest_path": "github-review-manifest-v0150.json",
        },
        "visual_manifest": "visual-manifest.json",
        "death_front_evidence": {
            "contract": f"{DEATH_EVIDENCE}/death-front-contract-v0150.json",
            "execution": f"{DEATH_EVIDENCE}/execution-evidence-v0.15.0.json",
            "visual_manifest": f"{DEATH_EVIDENCE}/death-front-visual-manifest-v0150.json",
            "targets": f"{DEATH_EVIDENCE}/death-front-targets-v0150.json",
            "frame_qa": f"{DEATH_EVIDENCE}/death-front-frame-qa-v0150.json",
            "temporal_qa": f"{DEATH_EVIDENCE}/death-front-temporal-qa-v0150.json",
            "negative_controls": f"{DEATH_EVIDENCE}/death-front-gate-negative-controls-v0150.json",
            "preview_gif": f"{DEATH_EVIDENCE}/death-front-v1/death-front-preview-v0150.gif",
            "spritesheet": f"{DEATH_EVIDENCE}/death-front-v1/death-front-spritesheet-v0150.png",
            "phase_marker_sheet": f"{DEATH_EVIDENCE}/death-front-phase-markers-v0150.png",
        },
        "recovery_evidence": {
...
def main() -> int:
    ...
    manifest = build(args)
    (output / "github-review-manifest-v0150.json").write_text(
