"""Validate the bounded v0.24.1 exact-head review manifest fail-closed."""
...
def main() -> int:
    ...
    failures: list[str] = []
    if value.get("schema_version") != VERSION or value.get("manifest_type") != "github-ci-orchestration-runtime-v0241-review":
    ...
    expected_scope = {
        ...
        "allowed_next_actions": ["external_review_orchestration_runtime_v0241"],
    ...
    if state_validation.get("status") != "ORCHESTRATION_RUNTIME_HARDENING_F31_F36_CORRECTION_TECHNICALLY_QUALIFIED_EXTERNAL_REVIEW_REQUIRED":
