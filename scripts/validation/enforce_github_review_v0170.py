"""Enforce the v0.17.0 review result after artifact upload."""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--equipment-exit", required=True)
    ...
    if validation.get("status") != "V0170_GITHUB_REVIEW_MANIFEST_PASSED": failures.append("manifest-validation-not-pass")
    ...
    result = {"schema_version": "0.17.0", "status": "PASS" if not failures else "FAIL", "failures": failures}
