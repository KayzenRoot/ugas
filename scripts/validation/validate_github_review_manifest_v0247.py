"""Validate the bounded v0.24.7 exact-head review manifest fail-closed."""
...
def main() -> int:
    ...
    failures: list[str] = []
    if value.get("schema_version") != VERSION or value.get("manifest_type") != "github-ci-orchestration-runtime-v0247-review":
    ...
    if controls.get("status") != "PASS" or len(controls_map) < 69:
    ...
    canonical_path = ROOT / "docs/evidence/orchestration-runtime-v0247/correction-history-v0247.json"
    try:
