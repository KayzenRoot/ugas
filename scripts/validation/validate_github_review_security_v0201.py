"""Check the v0.20.1 bounded review artifact for forbidden material."""
...
def main() -> int:
    ...
    result = {"schema_version": "0.20.1", "status": "PASS" if not failures else "FAIL", "failures": failures, "file_count": sum(1 for path in args.artifact_dir.rglob("*") if path.is_file())}
