"""Record bounded v0.25.0 V1 final acceptance test and official-validation results from CI logs."""
...
def main() -> int:
    ...
    (output / "test-results-v0250.json").write_text(json.dumps(test_record, indent=2) + "\n", encoding="utf-8")
    (output / "validation-results-v0250.json").write_text(json.dumps(validation_record, indent=2) + "\n", encoding="utf-8")
