"""Validate the active v0.24.5 state and its forward-only correction binding."""
...
from ugas.state_consistency_v0245 import validate_state_consistency
...
def main() -> int:
    ...
    binding_path = ROOT / "docs/evidence/orchestration-runtime-v0245/correction-history-v0245.json"
