"""Build the bounded GitHub-native v0.20.1 review manifest."""
...
EVIDENCE = "docs/evidence/environment-tilesets-runtime-v0201"
...
def main() -> int:
    ...
    value = build(args)
    (output / "github-review-manifest-v0201.json").write_text(json.dumps(value, indent=2, ensure_ascii=False) + "\n", encoding="utf-8")
    print(json.dumps({"status": "V0201_GITHUB_REVIEW_MANIFEST_BUILT", "base_sha": args.base_ref, "head_sha": args.head_ref, "pr_number": args.pr_number}))
    return 0
