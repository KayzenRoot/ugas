...
def main() -> int:
    ...
    try:
        ...
        if scope.get("version") != "0.21.3" or scope.get("phase") != "MAPS_MINIMAP" or scope.get("current_gate") != "MAPS_MINIMAP_RASTER_GOVERNANCE_INTEGRITY_TECHNICALLY_QUALIFIED" or scope.get("allowed_next_actions") != ["external_review_maps_minimap_v0213"]: failures.append("active-scope-invalid")
