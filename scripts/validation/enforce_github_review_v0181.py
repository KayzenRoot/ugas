"""Enforce the v0.18.1 review result after bounded artifact upload."""
...
if __name__ == "__main__":
    ...
    if validation.get("status") != "V0181_GITHUB_REVIEW_MANIFEST_PASSED": failures.append("manifest-validation-not-pass")
    ...
    result = {"schema_version": "0.18.1", "status": "PASS" if not failures else "FAIL", "failures": failures}; print(json.dumps(result, indent=2, ensure_ascii=False)); raise SystemExit(0 if not failures else 1)
