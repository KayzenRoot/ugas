"""Fail-closed bounded-artifact security validation for v0.14.1."""
...
if __name__ == "__main__":
    ...
    result = validate(Path(args.artifact_dir), Path(args.manifest) if args.manifest else None); result["schema_version"] = "0.14.1"
