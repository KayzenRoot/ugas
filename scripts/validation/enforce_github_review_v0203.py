"""Enforce the final fail-closed v0.20.3 review result after upload."""
...
def main() -> int:
    ...
    if args.manifest.is_file():
        ...
        if manifest.get("overall_status") != "PASS" or manifest.get("pull_request", {}).get("number") != 10: failures.append("manifest-not-pass-or-pr-invalid")
