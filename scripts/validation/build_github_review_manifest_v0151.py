...
def build(args: argparse.Namespace) -> dict[str, Any]:
    ...
    return {
        ...
        "death_front_evidence": {
            ...
            "contact_state": f"{DEATH_EVIDENCE}/death-front-contact-state-v0151.json",
            "ground_reference": f"{DEATH_EVIDENCE}/death-front-ground-reference-v0151.json",
            "foot_ground_qa": f"{DEATH_EVIDENCE}/death-front-foot-ground-qa-v0151.json",
            "terminal_support_qa": f"{DEATH_EVIDENCE}/death-front-terminal-support-qa-v0151.json",
            "death_vs_hit_qa": f"{DEATH_EVIDENCE}/death-front-death-vs-hit-qa-v0151.json",
            "negative_controls": f"{DEATH_EVIDENCE}/death-front-gate-negative-controls-v0151.json",
            "provenance_hash_correction": f"{DEATH_EVIDENCE}/v0141-provenance-sha256-correction-v0151.json",
            "v0150_rejection": f"{DEATH_EVIDENCE}/v0150-rejection-record-v0151.json",
