"""Run the v0.5.5 fatal state-consistency gate and persist its evidence."""
...
def main() -> int:
    ...
    result = validate_state_consistency(
        ...
        (ROOT / "REVIEW-v0.5.5.md").read_text(encoding="utf-8"),
    )
    evidence = {"schema_version": "0.5.5", "validator": "src/ugas/state_consistency.py", **result}
