"""Build the active v0.14.1 HIT_REACTION_FRONT GitHub review manifest."""
...
def build(args: argparse.Namespace) -> dict[str, Any]:
    ...
    tests = _load_result(Path(args.tests_json)) if getattr(args, "tests_json", None) else {"schema_version": "0.14.1", "status": "not_run", "exit_code": 99, "count": None, "passed": None, "failed": None, "parse_status": "not_run"}
    validation = _load_result(Path(args.validation_json), validation=True) if getattr(args, "validation_json", None) else {"schema_version": "0.14.1", "status": "not_run", "exit_code": 99, "checks": None, "passed": None, "failed": None, "parse_status": "not_run"}
    ...
    return {
        ...
        "review_index": {"historical_path": "docs/evidence/review-index-v0.12.2.json", "historical_version": "0.12.2", "status": "PRESERVED_BASELINE_VALIDATED", "active_manifest_path": "github-review-manifest-v0141.json"},
        "visual_manifest": "visual-manifest.json",
        "hit_front_evidence": {"contract": "hit-front-v0141/hit-front-contract-v0141.json", "execution": "hit-front-v0141/execution-evidence-v0.14.1.json", "visual_manifest": "hit-front-v0141/hit-front-visual-manifest-v0141.json", "negative_controls": "hit-front-v0141/hit-front-gate-negative-controls-v0141.json", "preview_gif": "hit-front-v0141/hit-front-v1/hit-front-preview-v0141.gif"},
...
def main() -> int:
    ...
    (output / "github-review-manifest-v0141.json").write_text(json.dumps(manifest, indent=2, ensure_ascii=False) + "\n", encoding="utf-8")
    ...
    print(json.dumps({"status": "V0141_GITHUB_REVIEW_MANIFEST_BUILT", "head_sha": manifest["pull_request"]["head_sha"], "base_sha": manifest["pull_request"]["base_sha"]}, ensure_ascii=False)); return 0
