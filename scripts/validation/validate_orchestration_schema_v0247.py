"""Validate the active v0.24.7 state and runtime evidence against their schemas."""
...
def main() -> int:
    ...
    failures: list[str] = []
    pairs = (
        ("current-state", ROOT / "docs/evidence/current-state.json", ROOT / "schemas/current-state-v0247.json"),
        ("orchestration-evidence", ROOT / "docs/evidence/orchestration-runtime-v0247/execution-evidence-v0247.json", ROOT / "schemas/orchestration-runtime-v0247.json"),
    )
