"""Build the bounded exact-head v0.22.2 review manifest."""
...
EVIDENCE = "docs/evidence/ui-asset-family-runtime-v0222"
...
def main() -> int:
    ...
    evidence_names = ("ui-family-manifest-v0222.json", "ui-style-authority-v0222.json", "component-class-contract-v0222.json", "progress-bar-contract-v0222.json", "nine-slice-independent-verification-v0222.json", "integration-authority-bindings-v0222.json", "cache-semantic-identity-v0222.json", "hard-gates-v0222.json", "negative-controls-v0222.json", "full-slice-two-run-determinism-v0222.json", "historical-authority-v0222.json", "governance-binding-validation-v0222.json", "production-registry-v0222.json", "capability-matrix-validation-v0222.json", "execution-evidence-v0222.json", "v0.22.1-rejection-correction-record-v0222.json")
