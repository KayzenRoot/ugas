"""Validate the bounded v0.24.5 exact-head review manifest fail-closed."""
...
def main() -> int:
    ...
    failures: list[str] = []
    if value.get("schema_version") != VERSION or value.get("manifest_type") != "github-ci-orchestration-runtime-v0245-review":
