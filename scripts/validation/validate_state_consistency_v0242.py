"""Validate the active v0.24.2 state and its forward-only correction binding."""
...
from ugas.state_consistency_v0242 import validate_state_consistency
...
def main() -> int:
    ...
    binding_path = ROOT / "docs/evidence/orchestration-runtime-v0242/correction-history-v0242.json"
