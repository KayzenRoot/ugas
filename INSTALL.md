...
The active correction is v0.20.2 on the existing PR #10; keep it OPEN and do not merge. Use [REVIEW-v0.20.2.md](REVIEW-v0.20.2.md) and the exact-head artifact as the authoritative handoff.
