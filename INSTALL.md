# Installing UGAS 0.24.2

The active correction is v0.24.2 Orchestration Runtime Hardening F-31R/F-32R/F-34R/F-35R over merged VFX v0.23.4; v0.24.0 and v0.24.1 evidence remain immutable correction history.
...
The active candidate is v0.24.2 on the existing GitHub-first PR #15. Use [REVIEW-v0.24.2.md](REVIEW-v0.24.2.md), the v0.24.2 evidence root and exact-head artifact as the authoritative handoff. Do not merge and do not start V1 Final Acceptance or production routing.
...
# Current release metadata: UGAS v0.24.2.
